// Script para corregir las fechas de TimeEntry en la sección por hora
// La fecha debe basarse en la hora de FIN del trabajo en Florida timezone
// 
// EJECUTAR:
// npx tsx scripts/fix-timeentry-dates.ts
...
async function main() {
  console.log('=== Corrección de fechas de TimeEntry (Sección Por Hora) ===\n')
  
  // Obtener todas las entradas con endTime (completadas)
  ...
  console.log(`Total entradas con endTime: ${entries.length}\n`)
