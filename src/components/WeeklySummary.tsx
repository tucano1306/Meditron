...
export function WeeklySummary() {
  ...
  const startEditingWeek = (week: WeeklySummaryData) => {
  ...
  const saveCompanyPayment = async (week: WeeklySummaryData) => {
    ...
    try {
      const res = await fetch('/api/payment/update-company-payment', {
        method: 'POST',
