...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-[100dvh] bg-gradient-to-br from-emerald-50 via-white to-blue-50 flex items-center justify-center px-4 py-6 sm:p-4">
        <Card className="w-full max-w-md border-0 shadow-xl">
          <CardContent className="pt-10 sm:pt-12 pb-6 sm:pb-8 text-center">
